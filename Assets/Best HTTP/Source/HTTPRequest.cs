...
namespace BestHTTP
{
    ...
    public enum HTTPRequestStates
    {
        ...
        /// <summary>
        /// The request finished without problem. Parsing the response done, the result can be used. The user defined callback will be called with a valid response object. The request窶冱 Exception property will be null.
        /// </summary>
        Finished,
        ...
        /// <summary>
        /// The request aborted by the client(HTTPRequest窶冱 Abort() function). The user defined callback will be called with a null response. The request窶冱 Exception property will be null.
        /// </summary>
        Aborted,

        /// <summary>
        /// Connecting to the server timed out. The user defined callback will be called with a null response. The request窶冱 Exception property will be null.
        /// </summary>
        ConnectionTimedOut,

        /// <summary>
        /// The request didn't finished in the given time. The user defined callback will be called with a null response. The request窶冱 Exception property will be null.
        /// </summary>
        TimedOut
    }
